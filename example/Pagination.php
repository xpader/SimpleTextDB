...
class Pagination {
	...
	*/
	function initialize($config) {
		...
		if ($this->set['totalRows']) {
			$this->pageCount = ceil($this->set['totalRows'] / $this->set['perPage']);
		}
	}
	...
	*/
	function makeLinks()
	{
		...
		if($total > $perPage) {
			...
			$multiPage = !empty($multiPage) ? $this->set['fullTagOpen'].$multiPage.$this->set['fullTagClose'] : '';
		}
